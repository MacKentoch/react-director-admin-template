    ...
    <AnimatedView>
      <div className="row">
        <div className="col-md-12">
          <Breadcrumb path={['Home', 'Dashboard', 'Current page']} />
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
            ...
            <div className="col-md-12">
              ...
              <Panel title="Pagination" hasTitle={true}>
                <div className="text-center">
                  <Pagination size="large" numberOfPagination={5} />
                </div>
                <div className="text-center">
                  <Pagination numberOfPagination={5} />
                </div>
                <div className="text-center">
                  <Pagination size="small" numberOfPagination={5} />
                </div>
                <div>
                  <h3>Default Example</h3>
                  <Pager aligned={false} previous={'Previous'} next={'Next'} />
                </div>
                <div>
                  <h3>Aligned links</h3>
                  <Pager
        ...
        <div className="col-lg-6">
          <TabPanel>
            ...
            />
            <TabPanelBody>
              <TabPanelBodyContent id="home1">&nbsp;Home</TabPanelBodyContent>
              <TabPanelBodyContent id="about1">&nbsp;About</TabPanelBodyContent>
          ...
          <section className="panel">
            ...
            <div className="panel-body">
              <div className="tab-content">
                ...
                <div id="about-3" className="tab-pane">
                  &nbsp;About
                </div>
          ...
          <div className="row">
            <div className="col-md-12">
              {/* <!--notification start--> */}
              <Panel title="Alerts" hasTitle={true}>
                <Alert type="danger">
          ...
          <div className="row">
            <div className="col-md-12">
              <Panel title="Default Buttons" hasTitle={true}>
                <Button
                  type="default"
                  onClick={() =>
                    console.log('it should handle onClick callback')
                  }
                >
                  Default
                </Button>
                ...
                <p className="m-bot-none text-center">
                  ...
                  <span className="badge badge-info">20</span>
                  <span className="badge badge-inverse">25</span>
